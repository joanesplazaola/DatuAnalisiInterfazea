...
class TPOTBase(BaseEstimator):
	...
	def __init__(self, generations=100, population_size=100, offspring_size=None,
				 ...
				 verbosity=0, disable_update_check=False, multi_output=False, per_loop_callback=None):
		...
		self.per_loop_callback = per_loop_callback
	...
	def _check_periodic_pipeline(self):
		...
		"""
		self.per_loop_callback(self._pbar.n, self._lambda * self.generations + self.population_size)
		self._update_top_pipeline()
