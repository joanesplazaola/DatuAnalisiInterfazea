...
@threading_timeoutable(default="Timeout")
def _wrapped_cross_val_score_ad(sklearn_pipeline, features, target, features_valid, target_valid,
								cv, scoring_function, sample_weight=None, groups=None, use_dask=False):
	try:

		from sklearn.metrics import confusion_matrix as conf_matrix, roc_auc_score
		with warnings.catch_warnings():
			warnings.simplefilter('ignore')
			...
			return scorer(pipeline, features_valid, target_valid)
